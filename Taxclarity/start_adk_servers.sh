...
# NOTE: TurboTax uses port 8005 (not 8003) because 8003 is reserved for the WebSocket proxy.
...
echo "Starting TurboTax A2A agent on :8005"
uvicorn agents.adk.turbotax_a2a.agent:a2a_app --port 8005 &
PID3=$!
